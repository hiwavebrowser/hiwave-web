...
- HiWave Sync (introduced v3) → v3 ≤ v5 → ✅ UNLOCKED
...
| Product | Type | Price |
|---------|------|-------|
| HiWave Starter | Fixed | $10.00 |
| HiWave Supporter | Fixed | $15.00 |
| HiWave Believer | Fixed | $20.00 |
| HiWave Early Adopter | Pay What You Want | Min $1.00 |
